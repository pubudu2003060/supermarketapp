...
export default function ProductCard({ productimage, name, rating, price, originalPrice, inStock }) {
    ...
    return (
        <div className="group  w-64 md:w-70 mx-2 bg-white relative flex flex-col rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-300">
            {/* Discount badge */}
            {discount > 0 && (
            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <div className="mt-auto flex items-center justify-between">
                    ...
                    <button
                        className={`flex items-center justify-center px-3 py-1.5 rounded-full text-sm transition-all duration-200 ${inStock
