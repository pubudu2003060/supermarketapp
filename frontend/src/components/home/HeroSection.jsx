...
export default function HeroSection() {
    ...
    const [heroHeight, setHeroHeight] = useState('calc(100vh - 150px)'); // Default estimation
        ...
        <div className={`w-full flex flex-col justify-start transition-colors duration-300 ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
            ...
            >
                ...
                <div className="absolute inset-0 z-20 flex flex-col justify-center items-start p-6 md:p-16 lg:p-24">
                    <div className={`${darkMode ? 'bg-gray-900 bg-opacity-60' : 'bg-white bg-opacity-75'} p-4 md:p-8 rounded-lg max-w-lg`}>
                        <h2 className={`${
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                        {categories.map((category, index) => (
                            <a
                                key={index}
                                href="#"
                                className={`flex flex-col items-center p-6 rounded-lg border transition duration-300 ${
                                    darkMode 
